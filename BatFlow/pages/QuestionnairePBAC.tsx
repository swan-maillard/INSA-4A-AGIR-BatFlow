...
const QuestionnairePBAC = ({ route, navigation }: any) => {
  ...
  const [answersQuestions, setAnswersQuestions] = useStorage('AGIR@answers-PBAC', {});
  ...
  useEffect(() => {
    ...
    const submitAnswersToApi = (allAnswers: string[]) => {
    ...
    const question = (i: number) => {
        switch (i) {
            case 0: return 'Choose product type:';
            case 1: return 'What is the blood intensity?';
            case 2: return 'Did you have any blood clots, and if so, what size?';
            case 3: return 'Did you have any blood flooding?';
        }
    };
    ...
    const possibleAnswers = (i: number) => {
        switch (i) {
            case 0:
                return (
                    <>
                        <Pressable onPress={handlePad} style={{...customStyles.answer, backgroundColor: colors.primary}}>
                            <CustomText style={{color: "white"}}>PAD</CustomText>
                        </Pressable>
                        <Pressable onPress={handleTampon} style={{...customStyles.answer, backgroundColor: colors.black}}>
            ...
            case 1:
                return (
                    <>
                        <Pressable onPress={handleLow} style={{...customStyles.answer, backgroundColor: colors.primary}}>
                            <CustomText style={{color: "white"}}>LOW</CustomText>
                        </Pressable>
                        <Pressable onPress={handleMedium} style={{...customStyles.answer, backgroundColor: colors.black}}>
                            <CustomText style={{color: "white"}}>MEDIUM</CustomText>
                        </Pressable>
                        <Pressable onPress={handleHigh} style={{...customStyles.answer, backgroundColor: colors.black}}>
            ...
            case 2:
                return (
                    <>
                        <Pressable onPress={handleNoneClot} style={{...customStyles.answer, backgroundColor: colors.primary}}>
                            <CustomText style={{color: "white"}}>NONE</CustomText>
                        </Pressable>
                        <Pressable onPress={handleSmallClot} style={{...customStyles.answer, backgroundColor: colors.black}}>
                            <CustomText style={{color: "white"}}>SMALL</CustomText>
                        </Pressable>
                        <Pressable onPress={handleBigClot} style={{...customStyles.answer, backgroundColor: colors.black}}>
            ...
            case 3:
                return (
                    <>
                        <Pressable onPress={handleFlooding} style={{...customStyles.answer, backgroundColor: colors.primary}}>
                            <CustomText style={{color: "white"}}>YES</CustomText>
                        </Pressable>
                        <Pressable onPress={handleNoFlooding} style={{...customStyles.answer, backgroundColor: colors.black}}>
