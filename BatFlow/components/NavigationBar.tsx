...
const NavigationBar = () => {
  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity style={{borderTopColor: colorBorder('Profile'), borderTopWidth: 3, padding: 10}} onPress={() => navigation.navigate('Profile')}>
      ...
      <TouchableOpacity style={{borderTopColor: colorBorder('Stats'), borderTopWidth: 3, padding: 10}} onPress={() => navigation.navigate('Stats')}>
      ...
      <TouchableOpacity style={{borderTopColor: colorBorder('Information'), borderTopWidth: 3, padding: 10}} onPress={() => navigation.navigate('Information')}>
      ...
      <TouchableOpacity style={{borderTopColor: colorBorder('Settings'), borderTopWidth: 3, padding: 10}} onPress={() => navigation.navigate('Settings')}>
